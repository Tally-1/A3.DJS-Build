...
module.exports = {
    ...
    execute(interaction) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let level = (_a = interaction.options.get("percentage")) === null || _a === void 0 ? void 0 : _a.value;
            if (level !== undefined) {
                level = level / 100;
                ...
                INIparser_1.default.sendCommand(request, "set-fog", bot.A3DJS_folder);
                yield bot.commandResponseReply(interaction, requestId, time, "Setting fog-level");
            }
        });
    },
};
