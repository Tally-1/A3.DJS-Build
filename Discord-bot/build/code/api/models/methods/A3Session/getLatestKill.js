...
function getLatestKill(timeLimit, playersOnly) {
    ...
    ;
    const valid = (lastPlayerKill === null || lastPlayerKill === void 0 ? void 0 : lastPlayerKill.time) > (new Date().getTime() + timeLimit);
    if (valid) {
        return last;
    }
    ;
