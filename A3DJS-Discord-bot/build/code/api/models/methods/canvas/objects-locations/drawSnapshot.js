...
function drawSnapShot(snapshot, sessionInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (backgroundCached) {
            ...
            yield this.setBackground(pencil, sessionInfo.map, backGroundData);
        }
        this.writeGameInfo(pencil, snapshot, sessionInfo, backGroundData);
        this.drawGameData(pencil, snapshot, backGroundData);
        canvas_1.default.storeCanvas(frame, "./gameImages/snapShot.jpg");
    });
}
