...
function liveFeedCombatStats(feed) {
    ...
    if (killCount > 0) {
        this.addFields({ name: 'Kills', value: "" + killCount, inline: true });
    }
    ;
    if (explCount > 0) {
        this.addFields({ name: 'Explosions', value: "" + explCount, inline: true });
    }
    ;
    if (shotsFired > 0) {
        this.addFields({ name: 'Bullets fired', value: "" + shotsFired, inline: true });
    }
    ;
    this.addFields({ name: '\u200B', value: '\u200B' });
    return this;
}
exports.default = liveFeedCombatStats;
