...
switch (platform) {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(localFileDir);
        try {
          if (localFileExisted) {

            console.log("using local: '"+localFileDir+"'");
            console.log("");

            nativeBinding = require(localFileDir)
          } else {

            console.log("using import: '@napi-rs/canvas-win32-x64-msvc'");
            console.log("");
